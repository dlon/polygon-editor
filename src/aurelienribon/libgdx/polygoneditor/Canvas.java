...
public class Canvas extends ApplicationAdapter {
    ...
    @Override
    public void render() {
        panZoom.update(Gdx.graphics.getDeltaTime());
    ...
    private void updateButtons() {
        if (selectedModel != null && mode == null) {
    ...
    private boolean isInsertEnabled() {
        ...
        for (Shape shape : selectedModel.shapes) {
            ...
            if (v1 != null && selectedPoints.contains(shape.vertices.get(0))) {
                return true;
            }
        }
    ...
    private void setMode(Mode mode) {
        ...
        if (mode == null) {
            ...
            if (lastShape != null && !lastShape.closed) {
                selectedModel.shapes.remove(lastShape);
            }
